    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (source0.src !== (source0_src_value = "clap.wav")) attr_dev(source0, "src", source0_src_value);
    			attr_dev(source0, "type", "audio/wav");
    			add_location(source0, file$2, 63, 24, 1683);
    			attr_dev(track0, "kind", "captions");
    			add_location(track0, file$2, 63, 64, 1723);
    			attr_dev(audio0, "data-key", "65");
    			add_location(audio0, file$2, 63, 2, 1661);
    			if (source1.src !== (source1_src_value = "hihat.wav")) attr_dev(source1, "src", source1_src_value);
    			attr_dev(source1, "type", "audio/wav");
    			add_location(source1, file$2, 64, 24, 1779);
    			attr_dev(track1, "kind", "captions");
    			add_location(track1, file$2, 64, 65, 1820);
    			attr_dev(audio1, "data-key", "83");
    			add_location(audio1, file$2, 64, 2, 1757);
    			if (source2.src !== (source2_src_value = "kick.wav")) attr_dev(source2, "src", source2_src_value);
    			attr_dev(source2, "type", "audio/wav");
    			add_location(source2, file$2, 65, 24, 1876);
    			attr_dev(track2, "kind", "captions");
    			add_location(track2, file$2, 65, 64, 1916);
    			attr_dev(audio2, "data-key", "68");
    			add_location(audio2, file$2, 65, 2, 1854);
    			if (source3.src !== (source3_src_value = "openhat.wav")) attr_dev(source3, "src", source3_src_value);
    			attr_dev(source3, "type", "audio/wav");
    			add_location(source3, file$2, 66, 24, 1972);
    			attr_dev(track3, "kind", "captions");
    			add_location(track3, file$2, 66, 67, 2015);
    			attr_dev(audio3, "data-key", "70");
    			add_location(audio3, file$2, 66, 2, 1950);
    			if (source4.src !== (source4_src_value = "boom.wav")) attr_dev(source4, "src", source4_src_value);
    			attr_dev(source4, "type", "audio/wav");
    			add_location(source4, file$2, 67, 24, 2071);
    			attr_dev(track4, "kind", "captions");
    			add_location(track4, file$2, 67, 64, 2111);
    			attr_dev(audio4, "data-key", "71");
    			add_location(audio4, file$2, 67, 2, 2049);
    			if (source5.src !== (source5_src_value = "ride.wav")) attr_dev(source5, "src", source5_src_value);
    			attr_dev(source5, "type", "audio/wav");
    			add_location(source5, file$2, 68, 24, 2167);
    			attr_dev(track5, "kind", "captions");
    			add_location(track5, file$2, 68, 64, 2207);
    			attr_dev(audio5, "data-key", "72");
    			add_location(audio5, file$2, 68, 2, 2145);
    			if (source6.src !== (source6_src_value = "snare.wav")) attr_dev(source6, "src", source6_src_value);
    			attr_dev(source6, "type", "audio/wav");
    			add_location(source6, file$2, 69, 24, 2263);
    			attr_dev(track6, "kind", "captions");
    			add_location(track6, file$2, 69, 65, 2304);
    			attr_dev(audio6, "data-key", "74");
    			add_location(audio6, file$2, 69, 2, 2241);
    			if (source7.src !== (source7_src_value = "tom.wav")) attr_dev(source7, "src", source7_src_value);
    			attr_dev(source7, "type", "audio/wav");
    			add_location(source7, file$2, 70, 24, 2360);
    			attr_dev(track7, "kind", "captions");
    			add_location(track7, file$2, 70, 63, 2399);
    			attr_dev(audio7, "data-key", "75");
    			add_location(audio7, file$2, 70, 2, 2338);
    			if (source8.src !== (source8_src_value = "tink.wav")) attr_dev(source8, "src", source8_src_value);
    			attr_dev(source8, "type", "audio/wav");
    			add_location(source8, file$2, 71, 24, 2455);
    			attr_dev(track8, "kind", "captions");
    			add_location(track8, file$2, 71, 64, 2495);
    			attr_dev(audio8, "data-key", "76");
    			add_location(audio8, file$2, 71, 2, 2433);
