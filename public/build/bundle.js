...
var app = (function () {
    ...
    // (8:2) {#each Object.values(days) as day}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:2) {#each Object.values(days) as day}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ fade, fly, days });
    	return [];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-1lf2jln");
    			add_location(p, file$1, 11, 1, 241);
    			attr_dev(span, "class", "menu fas fa-bars svelte-1lf2jln");
    			add_location(span, file$1, 12, 1, 271);
    			attr_dev(div0, "class", "welcome-description svelte-1lf2jln");
    			add_location(div0, file$1, 17, 2, 417);
    			attr_dev(div1, "class", "main-section svelte-1lf2jln");
    			add_location(div1, file$1, 13, 1, 349);
    			attr_dev(main, "class", "svelte-1lf2jln");
