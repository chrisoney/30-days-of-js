    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p0, "class", "svelte-6kroiw");
    			add_location(p0, file$6, 7, 6, 104);
    			attr_dev(p1, "class", "svelte-6kroiw");
    			add_location(p1, file$6, 8, 6, 121);
    			attr_dev(p2, "class", "svelte-6kroiw");
    			add_location(p2, file$6, 9, 6, 140);
    			attr_dev(div0, "class", "panel panel1 svelte-6kroiw");
    			add_location(div0, file$6, 6, 4, 71);
    			attr_dev(p3, "class", "svelte-6kroiw");
    			add_location(p3, file$6, 12, 6, 201);
    			attr_dev(p4, "class", "svelte-6kroiw");
    			add_location(p4, file$6, 13, 6, 219);
    			attr_dev(p5, "class", "svelte-6kroiw");
    			add_location(p5, file$6, 14, 6, 237);
    			attr_dev(div1, "class", "panel panel2 svelte-6kroiw");
    			add_location(div1, file$6, 11, 4, 168);
    			attr_dev(p6, "class", "svelte-6kroiw");
    			add_location(p6, file$6, 17, 6, 300);
    			attr_dev(p7, "class", "svelte-6kroiw");
    			add_location(p7, file$6, 18, 6, 324);
    			attr_dev(p8, "class", "svelte-6kroiw");
    			add_location(p8, file$6, 19, 6, 340);
    			attr_dev(div2, "class", "panel panel3 svelte-6kroiw");
    			add_location(div2, file$6, 16, 4, 267);
    			attr_dev(p9, "class", "svelte-6kroiw");
    			add_location(p9, file$6, 22, 6, 401);
    			attr_dev(p10, "class", "svelte-6kroiw");
    			add_location(p10, file$6, 23, 6, 419);
    			attr_dev(p11, "class", "svelte-6kroiw");
    			add_location(p11, file$6, 24, 6, 436);
    			attr_dev(div3, "class", "panel panel4 svelte-6kroiw");
    			add_location(div3, file$6, 21, 4, 368);
    			attr_dev(p12, "class", "svelte-6kroiw");
    			add_location(p12, file$6, 27, 6, 499);
    			attr_dev(p13, "class", "svelte-6kroiw");
    			add_location(p13, file$6, 28, 6, 517);
    			attr_dev(p14, "class", "svelte-6kroiw");
    			add_location(p14, file$6, 29, 6, 533);
    			attr_dev(div4, "class", "panel panel5 svelte-6kroiw");
    			add_location(div4, file$6, 26, 4, 466);
    			attr_dev(div5, "class", "panels svelte-6kroiw");
    			add_location(div5, file$6, 5, 2, 46);
    			attr_dev(div6, "class", "day-main svelte-6kroiw");
