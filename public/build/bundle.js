    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div6 = element("div");
    			p15 = element("p");
    			attr_dev(p0, "class", "svelte-t3huaq");
    			add_location(p0, file$6, 24, 6, 563);
    			attr_dev(p1, "class", "svelte-t3huaq");
    			add_location(p1, file$6, 25, 6, 580);
    			attr_dev(p2, "class", "svelte-t3huaq");
    			add_location(p2, file$6, 26, 6, 599);
    			attr_dev(div0, "class", "panel panel1 svelte-t3huaq");
    			add_location(div0, file$6, 23, 4, 530);
    			attr_dev(p3, "class", "svelte-t3huaq");
    			add_location(p3, file$6, 29, 6, 660);
    			attr_dev(p4, "class", "svelte-t3huaq");
    			add_location(p4, file$6, 30, 6, 678);
    			attr_dev(p5, "class", "svelte-t3huaq");
    			add_location(p5, file$6, 31, 6, 696);
    			attr_dev(div1, "class", "panel panel2 svelte-t3huaq");
    			add_location(div1, file$6, 28, 4, 627);
    			attr_dev(p6, "class", "svelte-t3huaq");
    			add_location(p6, file$6, 34, 6, 759);
    			attr_dev(p7, "class", "svelte-t3huaq");
    			add_location(p7, file$6, 35, 6, 783);
    			attr_dev(p8, "class", "svelte-t3huaq");
    			add_location(p8, file$6, 36, 6, 799);
    			attr_dev(div2, "class", "panel panel3 svelte-t3huaq");
    			add_location(div2, file$6, 33, 4, 726);
    			attr_dev(p9, "class", "svelte-t3huaq");
    			add_location(p9, file$6, 39, 6, 860);
    			attr_dev(p10, "class", "svelte-t3huaq");
    			add_location(p10, file$6, 40, 6, 878);
    			attr_dev(p11, "class", "svelte-t3huaq");
    			add_location(p11, file$6, 41, 6, 895);
    			attr_dev(div3, "class", "panel panel4 svelte-t3huaq");
    			add_location(div3, file$6, 38, 4, 827);
    			attr_dev(p12, "class", "svelte-t3huaq");
    			add_location(p12, file$6, 44, 6, 958);
    			attr_dev(p13, "class", "svelte-t3huaq");
    			add_location(p13, file$6, 45, 6, 976);
    			attr_dev(p14, "class", "svelte-t3huaq");
    			add_location(p14, file$6, 46, 6, 992);
    			attr_dev(div4, "class", "panel panel5 svelte-t3huaq");
    			add_location(div4, file$6, 43, 4, 925);
    			attr_dev(div5, "class", "panels svelte-t3huaq");
    			add_location(div5, file$6, 22, 2, 505);
    			attr_dev(p15, "class", "svelte-t3huaq");
    			add_location(p15, file$6, 50, 42, 1069);
    			attr_dev(div6, "class", "hide panel open open-active svelte-t3huaq");
    			add_location(div6, file$6, 50, 1, 1028);
    			attr_dev(div7, "class", "day-main svelte-t3huaq");
