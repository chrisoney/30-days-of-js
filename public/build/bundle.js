...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div6 = element("div");
    			p15 = element("p");
    			attr_dev(p0, "class", "svelte-etwxkq");
    			add_location(p0, file$6, 24, 6, 563);
    			attr_dev(p1, "class", "svelte-etwxkq");
    			add_location(p1, file$6, 25, 6, 580);
    			attr_dev(p2, "class", "svelte-etwxkq");
    			add_location(p2, file$6, 26, 6, 599);
    			attr_dev(div0, "class", "panel panel1 svelte-etwxkq");
    			add_location(div0, file$6, 23, 4, 530);
    			attr_dev(p3, "class", "svelte-etwxkq");
    			add_location(p3, file$6, 29, 6, 660);
    			attr_dev(p4, "class", "svelte-etwxkq");
    			add_location(p4, file$6, 30, 6, 678);
    			attr_dev(p5, "class", "svelte-etwxkq");
    			add_location(p5, file$6, 31, 6, 696);
    			attr_dev(div1, "class", "panel panel2 svelte-etwxkq");
    			add_location(div1, file$6, 28, 4, 627);
    			attr_dev(p6, "class", "svelte-etwxkq");
    			add_location(p6, file$6, 34, 6, 759);
    			attr_dev(p7, "class", "svelte-etwxkq");
    			add_location(p7, file$6, 35, 6, 783);
    			attr_dev(p8, "class", "svelte-etwxkq");
    			add_location(p8, file$6, 36, 6, 799);
    			attr_dev(div2, "class", "panel panel3 svelte-etwxkq");
    			add_location(div2, file$6, 33, 4, 726);
    			attr_dev(p9, "class", "svelte-etwxkq");
    			add_location(p9, file$6, 39, 6, 860);
    			attr_dev(p10, "class", "svelte-etwxkq");
    			add_location(p10, file$6, 40, 6, 878);
    			attr_dev(p11, "class", "svelte-etwxkq");
    			add_location(p11, file$6, 41, 6, 895);
    			attr_dev(div3, "class", "panel panel4 svelte-etwxkq");
    			add_location(div3, file$6, 38, 4, 827);
    			attr_dev(p12, "class", "svelte-etwxkq");
    			add_location(p12, file$6, 44, 6, 958);
    			attr_dev(p13, "class", "svelte-etwxkq");
    			add_location(p13, file$6, 45, 6, 976);
    			attr_dev(p14, "class", "svelte-etwxkq");
    			add_location(p14, file$6, 46, 6, 992);
    			attr_dev(div4, "class", "panel panel5 svelte-etwxkq");
    			add_location(div4, file$6, 43, 4, 925);
    			attr_dev(div5, "class", "panels svelte-etwxkq");
    			add_location(div5, file$6, 22, 2, 505);
    			attr_dev(p15, "class", "svelte-etwxkq");
    			add_location(p15, file$6, 50, 42, 1069);
    			attr_dev(div6, "class", "hide panel open open-active svelte-etwxkq");
    			add_location(div6, file$6, 50, 1, 1028);
    			attr_dev(div7, "class", "day-main svelte-etwxkq");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "search svelte-1tp71da");
    			attr_dev(input, "placeholder", "City or State");
    			add_location(input, file$7, 39, 4, 1152);
    			attr_dev(li0, "class", "svelte-1tp71da");
    			add_location(li0, file$7, 41, 6, 1250);
    			attr_dev(li1, "class", "svelte-1tp71da");
    			add_location(li1, file$7, 42, 6, 1283);
    			attr_dev(ul, "class", "suggestions svelte-1tp71da");
    			add_location(ul, file$7, 40, 4, 1219);
    			attr_dev(form, "class", "search-form svelte-1tp71da");
    			add_location(form, file$7, 38, 2, 1121);
    			attr_dev(div, "class", "day-main svelte-1tp71da");
    			add_location(div, file$7, 37, 0, 1096);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<DaySix> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			em.textContent = "Psst: have a look at the JavaScript Console";
    			t1 = text(" 💁");
    			add_location(em, file$8, 32, 4, 917);
    			add_location(p, file$8, 32, 1, 914);
    			attr_dev(div, "class", "day-main svelte-1t7hos2");
    			add_location(div, file$8, 31, 0, 890);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ people, comments });
    	return [];
    }
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "page svelte-1etalgk");
    ...
    function create_fragment$w(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-1etalgk");
    			add_location(p, file$w, 58, 1, 2624);
    			attr_dev(span, "class", "menu fas fa-bars svelte-1etalgk");
    			add_location(span, file$w, 59, 1, 2654);
    			attr_dev(div0, "class", "pages svelte-1etalgk");
    			add_location(div0, file$w, 64, 2, 2793);
    			attr_dev(div1, "class", "main-section svelte-1etalgk");
    			add_location(div1, file$w, 60, 1, 2723);
    			attr_dev(main, "class", "svelte-1etalgk");
